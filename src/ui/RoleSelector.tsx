      ...
      <div className="w-full max-w-sm space-y-3">
        <button type="button" onClick={() => select('tecnico')}
          ...
          <div className="text-xs text-slate-400 mt-1">
            Capturo fotos y datos en campo. Exporto ZIP al terminar para enviarlo por WhatsApp.
          </div>
        </button>
        ...
        <button type="button" onClick={() => select('jp')}
          ...
          <div className="text-xs text-slate-400 mt-1">
            Importo el ZIP del técnico, reviso los puntos y exporto el informe final.
          </div>
        </button>
      </div>

      <p className="text-xs text-slate-600 text-center max-w-xs">
        El rol se guarda localmente en este dispositivo. Puedes cambiarlo en cualquier momento tocando tu rol en la barra superior.
      </p>
    </div>
  )
}
